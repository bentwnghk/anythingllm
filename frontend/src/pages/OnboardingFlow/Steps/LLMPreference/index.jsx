...
const DESCRIPTION =
  "Mr.🆖 DocChat can work with many LLM providers. This will be the service which handles chatting.";
...
const LLMS = [
  ...
  },
  {
    ...
    description:
      "Use a downloaded custom Llama model for chatting on Mr.🆖 DocChat.",
  },
];
...
export default function LLMPreference({
  ...
  const handleSubmit = async (e) => {
    ...
    // Default to Mr.🆖 DocChat embedder and LanceDB
