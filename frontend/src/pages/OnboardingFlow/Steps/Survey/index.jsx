...
const TITLE = "Welcome to Mr.🆖 DocChat";
const DESCRIPTION = "Help us make Mr.🆖 DocChat built for your needs. Optional.";
      ...
      <form onSubmit={handleSubmit} ref={formRef} className="">
        ...
        <div className="mt-8">
          <label
            ...
            htmlFor="use_case"
          >
            What will you use Mr.🆖 DocChat for?{" "}
          </label>
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            placeholder="If you have any questions or comments right now, you can leave them here and we will get back to you. You can also email mr.ng@mystudies.net"
            wrap="soft"
            autoComplete="off"
          />
        </div>
